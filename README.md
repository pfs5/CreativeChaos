...
## Why?
I'm a software engineer. Software engineers have a lot of work to do but, even though we can easily manage complex systems and multilevel dependency chains, we might not be the most organized people in the world.
...
So I did the classic programmer move and decided to do implement it myself. It might take slightly longer, as side projects usually do,  yet I can tune it to my needs precisely. If someone happens to have similar wishes to me, my tool might even have more than one user!
...
* **Task list** - Kinda obvious this one yet I want it simple, readable and useful.
...
## How?
First, I did the sensible thing and started from scratch, and I mean *from scratch*. I started from blank window and begun implementing a UI framework. I even designed the interface, with interactions and all. 

Half way trough I realized I will never finish and went back to the drawing board.
