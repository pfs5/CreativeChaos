...
public:
	...
	// We provide controls to move tasks between collections. Since collections depend on task views, we leave this responsibility to task view implementations.
